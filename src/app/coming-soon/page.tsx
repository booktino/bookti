  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: `linear-gradient(rgba(93,202,165,0.04) 1px, transparent 1px),
      ...
      <div style={{
        ...
        width: "520px", height: "520px", pointerEvents: "none", zIndex: 0,
        background: "radial-gradient(circle, rgba(15,110,86,0.38) 0%, transparent 68%)",
      }} />
      {/* Glow bottom-left */}
      <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            width: 36, height: 36, borderRadius: 8, background: "#0F6E56",
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 14, fontWeight: 800,
          }}>
            <span style={{ color: "#fff" }}>B</span>
            <span style={{ color: "#5DCAA5" }}>ti</span>
          </div>
          <span style={{ fontSize: 17, fontWeight: 700, letterSpacing: "-0.3px" }}>Bookti</span>
        </div>
        <div style={{
          fontSize: 11, fontWeight: 700, letterSpacing: "2.5px",
          color: "#5DCAA5", background: "rgba(93,202,165,0.08)",
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: "#5DCAA5", marginBottom: 18, textTransform: "uppercase",
        }}>
        ...
        <h1 style={{
          ...
          lineHeight: 1.05, letterSpacing: "-2.5px", margin: "0 0 20px",
        }}>
          Booking som<br />
          <span style={{
            WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
            backgroundImage: "linear-gradient(135deg, #5DCAA5 0%, #0F6E56 100%)",
          }}>faktisk fungerer</span>
        </h1>
 
        <p style={{
          fontSize: 17, color: "rgba(255,255,255,0.48)",
          maxWidth: 460, lineHeight: 1.68, marginBottom: 38, fontWeight: 400,
        }}>
          La kundene booke selv — du får beskjed med én gang.
          Ingen dobbeltbookinger, ingen tapte avtaler.
        </p>
        ...
        {!submitted ? (
          <form
            ...
            style={{ display: "flex", gap: 8, marginBottom: 52, width: "100%", maxWidth: 420, flexWrap: "wrap" }}
          >
            <input
              type="email" placeholder="din@epost.no"
              value={email} onChange={e => setEmail(e.target.value)} required
              style={{
                flex: 1, minWidth: 170, padding: "13px 18px",
            ...
            <button type="submit" style={{
              padding: "13px 22px", background: "#0F6E56", color: "#fff",
          ...
          <div style={{
            marginBottom: 52, padding: "13px 28px",
            background: "rgba(93,202,165,0.1)",
            border: "1px solid rgba(93,202,165,0.28)",
            borderRadius: 10, color: "#5DCAA5", fontSize: 15, fontWeight: 600,
          }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 72 }}>
          {[
            { val: timeLeft.dager, label: "DAGER" },
            { val: timeLeft.timer, label: "TIMER" },
            { val: timeLeft.minutter, label: "MINUTTER" },
            { val: timeLeft.sekunder, label: "SEKUNDER" },
          ].map(({ val, label }, i) => (
            <div key={label} style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <div style={{ textAlign: "center" }}>
                <div style={{
                  fontSize: "clamp(28px, 4vw, 50px)", fontWeight: 900,
                  letterSpacing: "-1px", minWidth: 62, padding: "10px 14px",
                ...
                <div style={{ fontSize: 9, color: "rgba(255,255,255,0.28)", letterSpacing: "2px", marginTop: 6 }}>
                  {label}
                </div>
              </div>
              {i < 3 && (
                <span style={{ fontSize: 26, color: "rgba(255,255,255,0.13)", fontWeight: 900, paddingBottom: 22 }}>:</span>
              )}
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 32 }}>
          {[
            { id: "kunde", label: "👤  Kundeside" },
            { id: "eier", label: "🏪  Salongpanel" },
          ].map(({ id, label }) => (
            <button key={id} onClick={() => setActiveTab(id)} style={{
              ...
              color: activeTab === id ? "#5DCAA5" : "rgba(255,255,255,0.32)",
        ...
        {activeTab === "kunde" && (
          <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: "1 1 200px" }}>
              ...
              {[
                { name: "Klipp og stell", price: "kr 350", min: "45 min" },
                { name: "Farging", price: "kr 750", min: "90 min" },
                { name: "Manikyr", price: "kr 280", min: "40 min" },
                { name: "Massasje", price: "kr 580", min: "60 min" },
              ].map((s, i) => (
                <div key={s.name} style={{
                  padding: "11px 14px", borderRadius: 10, marginBottom: 7,
                  background: i === 0 ? "rgba(93,202,165,0.1)" : "rgba(255,255,255,0.03)",
                  border: i === 0 ? "1px solid rgba(93,202,165,0.28)" : "1px solid rgba(255,255,255,0.07)",
                  ...
                  <div>
                    <div style={{
                      ...
                      color: i === 0 ? "#5DCAA5" : "rgba(255,255,255,0.65)",
                    }}>{s.name}</div>
                    <div style={{ fontSize: 11, color: "rgba(255,255,255,0.28)", marginTop: 2 }}>{s.min}</div>
                  </div>
                  <div style={{
                    fontSize: 13, fontWeight: 700,
                    color: i === 0 ? "#5DCAA5" : "rgba(255,255,255,0.35)",
                  }}>{s.price}</div>
                </div>
              ))}
            </div>
            ...
            <div style={{ flex: "1 1 260px" }}>
              <div style={{
                fontSize: 10, color: "rgba(255,255,255,0.28)",
                letterSpacing: "2.5px", marginBottom: 12,
              }}>VELG DATO OG TID — JUNI 2026</div>
 
              {/* Days row */}
              <div style={{ display: "flex", gap: 6, marginBottom: 16 }}>
                {[
                  { d: "Man", n: 8 }, { d: "Tir", n: 9 }, { d: "Ons", n: 10 },
                  { d: "Tor", n: 11 }, { d: "Fre", n: 12 },
                ].map(({ d, n }, i) => (
                  <div key={n} style={{
                    flex: 1, textAlign: "center", padding: "8px 4px", borderRadius: 9,
                    cursor: "pointer",
                    background: i === 1 ? "#0F6E56" : "rgba(255,255,255,0.04)",
                    border: i === 1 ? "1px solid rgba(93,202,165,0.5)" : "1px solid rgba(255,255,255,0.07)",
                  }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 7 }}>
                {slots.map((s, i) => {
                  ...
                  return (
                    <div key={s} onClick={() => !booked && setSelectedSlot(i)} style={{
                      padding: "10px 0", borderRadius: 9, textAlign: "center",
                      fontSize: 14, fontWeight: 700,
                      cursor: booked ? "not-allowed" : "pointer",
                      background: booked ? "transparent" : sel ? "#0F6E56" : "rgba(255,255,255,0.05)",
                      border: booked ? "1px solid rgba(255,255,255,0.05)"
                        : sel ? "1px solid rgba(93,202,165,0.6)"
                        : "1px solid rgba(255,255,255,0.1)",
                      color: booked ? "rgba(255,255,255,0.18)"
                        : sel ? "#fff"
              ...
              {selectedSlot !== null && (
                <button style={{
                  ...
                  background: "linear-gradient(135deg, #0F6E56 0%, #5DCAA5 100%)",
        ...
        {activeTab === "eier" && (
          <div>
            ...
            <div style={{
              ...
              display: "flex", alignItems: "center", gap: 12, color: "#5DCAA5",
            }}>
              <span style={{ fontSize: 20 }}>🔔</span>
              <div>
                <div style={{ fontWeight: 700 }}>Ny bestilling!</div>
                <div style={{ opacity: 0.62, fontSize: 12, marginTop: 1 }}>
                  Sara Andersen — Mandag 9. juni kl. 15:30
                </div>
              </div>
              <div style={{ marginLeft: "auto", fontSize: 11, opacity: 0.38, whiteSpace: "nowrap" }}>
                akkurat nå
              </div>
            </div>
            ...
            <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 9, flex: "0 0 auto" }}>
                {[
                  { label: "Avtaler i dag", val: "8", accent: true },
                  { label: "Inntekt denne uken", val: "kr 6.800", accent: false },
                  { label: "Belagte timer", val: "87%", accent: true },
                  { label: "Aktive kunder", val: "124", accent: false },
                ].map(({ label, val, accent }) => (
                  <div key={label} style={{
                    padding: "12px 18px", borderRadius: 11, minWidth: 162,
                    background: "rgba(255,255,255,0.04)",
                    border: "1px solid rgba(255,255,255,0.08)",
                  }}>
              ...
              <div style={{ flex: 1, minWidth: 200 }}>
                <div style={{
                  fontSize: 10, color: "rgba(255,255,255,0.28)",
                  letterSpacing: "2.5px", marginBottom: 12,
                }}>DAGENS AVTALER — MANDAG 9. JUNI</div>
                {[
                  { time: "09:00", name: "Anna Kowalczyk", service: "Klipp og stell", done: true },
                  { time: "10:30", name: "Maria Lindstad", service: "Farging", done: true },
                  { time: "13:00", name: "Ingrid Haugen", service: "Manikyr", done: false },
                  { time: "14:30", name: "Sara Andersen", service: "Massasje", done: false },
                  { time: "15:30", name: "Kari Olsen", service: "Klipp", done: false },
                ].map(({ time, name, service, done }) => (
                  <div key={time} style={{
                    display: "flex", alignItems: "center", gap: 12,
                    padding: "10px 13px", borderRadius: 9, marginBottom: 6,
                    background: done ? "rgba(255,255,255,0.02)" : "rgba(93,202,165,0.06)",
                    border: done ? "1px solid rgba(255,255,255,0.05)" : "1px solid rgba(93,202,165,0.15)",
                    opacity: done ? 0.4 : 1, transition: "opacity 0.2s",
                  }}>
                    <div style={{
                      fontSize: 12, fontWeight: 800, color: "#5DCAA5",
                      minWidth: 44, fontFamily: "monospace",
                    }}>{time}</div>
                    <div style={{ flex: 1 }}>
                    ...
                    <div style={{
                      ...
                      background: done ? "rgba(255,255,255,0.05)" : "rgba(93,202,165,0.14)",
                      color: done ? "rgba(255,255,255,0.25)" : "#5DCAA5",
                    }}>
